...
import { ArrowLeft, Hexagon, MessageCircle, Clock, CheckCircle, Star, Users, Headphones } from "lucide-react";
                        ...
                        <motion.section variants={staggerItem} className="text-center space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-xl lg:text-2xl text-[#8B9299] leading-relaxed max-w-3xl mx-auto">
                                    Your AI-powered customer support specialist who never sleeps, never gets frustrated, and always delivers exceptional service.
                                </p>
                            </div>
                        </motion.section>

                        {/* What Cassie Does Section */}
                        <motion.section variants={staggerItem} className="space-y-12">
                            <div className="text-center space-y-4">
                                ...
                                <p className="text-xl text-[#8B9299] max-w-2xl mx-auto">
                                    Cassie handles your customer support with AI precision and human-like empathy
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        ...
                                        description: "Instant responses to customer inquiries across all channels"
                                    },
                                    {
                                        icon: Clock,
                                    ...
                                    },
                                    {
                                        ...
                                        description: "Solve common problems instantly with AI-powered solutions"
                                    },
                                    {
                                        icon: Star,
                                        title: "Customer Satisfaction",
                                        description: "Track and improve customer satisfaction scores automatically"
                                    },
                                    {
                                        icon: Headphones,
                            ...
                            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                                {[
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`relative bg-white/60 backdrop-blur-xl border rounded-3xl p-8 shadow-lg group-hover:shadow-2xl transition-all duration-300 ${plan.popular ? 'border-[#2D1A53]/30' : 'border-white/40'
                                                }`}
                                            style={{
                                                background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0.2) 100%)',
                                                boxShadow: '0 8px 32px rgba(45, 26, 83, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.4)',
